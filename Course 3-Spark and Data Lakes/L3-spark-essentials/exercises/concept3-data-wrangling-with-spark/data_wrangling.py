...
path = "./L3-spark-essentials/exercises/data/sparkify_log_small.json"
...
user_log_valid_df = user_log_df.dropna(
    how="any", subset=["userId", "sessionId"])
...
flag_downgrade_event = udf(
    lambda x: 1 if x == "Submit Downgrade" else 0, IntegerType())
