...
path = "./L3-spark-essentials/exercises/data/sparkify_log_small_2.json"
...
spark.udf.register("get_hour", lambda x: int(
    datetime.datetime.fromtimestamp(x / 1000.0).hour))
