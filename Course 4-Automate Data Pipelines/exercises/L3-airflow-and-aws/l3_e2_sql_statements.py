...
# TODO: change the S3 bucket to be the S3 bucket you created
COPY_MONTHLY_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://dend-phoebe/data-pipelines/divvy/partitioned/{year}/{month}/divvy_trips.csv"
)

# TODO: change the S3 bucket to be the S3 bucket you created
COPY_ALL_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://dend-phoebe/data-pipelines/divvy/unpartitioned/divvy_trips_2018.csv"
)

# TODO: change the S3 bucket to be the S3 bucket you created
COPY_STATIONS_SQL = COPY_SQL.format(
    "stations",
    "s3://dend-phoebe/data-pipelines/divvy/unpartitioned/divvy_stations_2017.csv"
)
